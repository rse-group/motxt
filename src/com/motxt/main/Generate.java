...
public class Generate extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/com/motxt/main/generate";
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                 ...
                 * "@generated"
                 * tag in the Javadoc of this method to "@generated NOT". Without this new tag,
                 * any compilation
                 * of the Acceleo module with the main template that has caused the creation of
                 * this class will
                 ...
                 * generation
                 * If your main template is called on an element of your model and a String, you
                 * can
                 ...
                 * property loader.
                 * The behavior of the properties loader service is explained in the Acceleo
                 * documentation
                 * (Help -> Help Contents).
                 */
     ...
     * {@link org.eclipse.acceleo.engine.generation.strategy.PreviewStrategy}. Both
     * of these aren't aware of
     * the running Eclipse and can be used standalone.
     * </p>
     * <p>
     * If you need the file generation to be aware of the workspace (A typical
     * example is when you wanna
     * override files that are under clear case or any other VCS that could forbid
     * the overriding), then
     * return a new
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(org.eclipse.ocl.ecore.EcorePackage.class)) {
            resourceSet.getPackageRegistry().put("http://www.eclipse.org/ocl/1.1.0/Ecore",
                    org.eclipse.ocl.ecore.EcorePackage.eINSTANCE);
        }
        if (!isInWorkspace(org.eclipse.acceleo.model.mtl.MtlPackage.class)) {
            resourceSet.getPackageRegistry().put(org.eclipse.acceleo.model.mtl.MtlPackage.eNS_URI,
                    org.eclipse.acceleo.model.mtl.MtlPackage.eINSTANCE);
        }
         ...
         * have been generated at the beginning of this method. Do not register the
         * package using this mechanism if
         ...
         * containing the package has not
         * been register by EMF and Acceleo should register it automatically. If you
         * want to use the generator in
